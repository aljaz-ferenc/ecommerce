  ...
  return (
    <div className='shipping'>
      <h3>Choose a shipping option</h3>
        <ShippingOption id={123} price={5.53} image='https://hbrtheedcngbriamntkr.supabase.co/storage/v1/object/public/images/express-shipping.png' check={true} title='Express shipping' time={'1 - 2 days'} description='Choose express shipping when you’re sending a time-sensitive package or freight shipment that needs to be delivered by a certain deadline.'/>
